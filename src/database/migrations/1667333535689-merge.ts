...
export class merge1667333535689 implements MigrationInterface {
  name = 'merge1667333535689';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "workers_data" ADD CONSTRAINT "FK_0fd0a9f4a630483e8467ee1c704" FOREIGN KEY ("workerId") REFERENCES "worker_experiences"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "workers_data" DROP CONSTRAINT "FK_0fd0a9f4a630483e8467ee1c704"`,
    );
    await queryRunner.query(
