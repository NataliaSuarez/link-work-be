...
export class init1665749366226 implements MigrationInterface {
  name = 'init1665749366226';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."clocks_history_clocktype_enum" AS ENUM('1', '2')`,
    );
    await queryRunner.query(
      `CREATE TABLE "clocks_history" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clockType" "public"."clocks_history_clocktype_enum" NOT NULL, "shiftId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_3f53403d067cb3aae833f9b06e7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."shift_status_enum" AS ENUM('0', '1', '2', '3', '4')`,
    );
    await queryRunner.query(
      `CREATE TABLE "shift" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clockIn" boolean NOT NULL DEFAULT false, "confirmedClockIn" boolean NOT NULL DEFAULT false, "clockOut" boolean NOT NULL DEFAULT false, "confirmedClockOut" boolean NOT NULL DEFAULT false, "autoConfirmed" TIMESTAMP WITH TIME ZONE, "status" "public"."shift_status_enum" NOT NULL DEFAULT '0', "workerId" integer NOT NULL, "offerId" integer NOT NULL, CONSTRAINT "REL_62be1e0c53b77c2ec2a34ff525" UNIQUE ("offerId"), CONSTRAINT "PK_53071a6485a1e9dc75ec3db54b9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "clocks_history" ADD CONSTRAINT "FK_281b03c96d9a4ea2e7d4668cbdc" FOREIGN KEY ("shiftId") REFERENCES "shift"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "clocks_history" ADD CONSTRAINT "FK_7fc3a9a700fecc89d892c42de69" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "clocks_history" DROP CONSTRAINT "FK_7fc3a9a700fecc89d892c42de69"`,
    );
    await queryRunner.query(
      `ALTER TABLE "clocks_history" DROP CONSTRAINT "FK_281b03c96d9a4ea2e7d4668cbdc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "clocks_history"`);
    await queryRunner.query(
      `DROP TYPE "public"."clocks_history_clocktype_enum"`,
    );
